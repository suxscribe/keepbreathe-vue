export const breathData = [
  {
    ...
    'ru-RU': {
      name: 'Пранаяма',
      description:
        'Пранаяма — дыхательные упражнения, оказывающие комплексное воздействие на тело и нервную систему',
  ...
  },
  {
    ...
    'ru-RU': {
      ...
      duration: '5 — 7 минут',
      tips:
        'Упражнение выполняется сидя. Старайтесь больше "дышать в брюшную полость", чтобы она расширялась и сжималась. Также старайтесь расслабить плечи, сделать их неподвижными при дыхании.',
    },
  },
  {
    id: 7,
